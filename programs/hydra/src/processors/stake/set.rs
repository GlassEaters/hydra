...
pub struct SetTokenMemberStakeByAuthority<'info> {
    #[account(mut)]
    ...
    constraint = membership_mint_token_account.owner == fanout.authority
    )]
...
pub fn set_token_member_stake_by_authority(ctx: Context<SetTokenMemberStakeByAuthority>, shares: u64) -> ProgramResult {
