...
export type FanoutIDL = {
  ...
  instructions: [
    {
      ...
      accounts: [
        ...
        { name: "holdingAccount"; isMut: true; isSigner: false },
        { name: "systemProgram"; isMut: false; isSigner: false },
        { name: "membershipMint"; isMut: false; isSigner: false },
        { name: "rent"; isMut: false; isSigner: false },
        { name: "tokenProgram"; isMut: false; isSigner: false }
      ];
      args: [{ name: "args"; type: { defined: "InitializeFanoutArgs" } }];
    },
    {
      name: "initForMint";
      accounts: [
        { name: "authority"; isMut: false; isSigner: true },
        { name: "fanout"; isMut: true; isSigner: false },
        { name: "fanoutForMint"; isMut: true; isSigner: false },
        { name: "mintHoldingAccount"; isMut: true; isSigner: false },
        { name: "mint"; isMut: false; isSigner: false },
        { name: "systemProgram"; isMut: false; isSigner: false },
        { name: "rent"; isMut: false; isSigner: false }
      ];
      args: [
        { name: "args"; type: { defined: "InitializeFanoutForMintArgs" } }
      ];
    },
    {
      name: "addMemberWallet";
      accounts: [
        { name: "authority"; isMut: false; isSigner: true },
        { name: "account"; isMut: false; isSigner: false },
        { name: "fanout"; isMut: true; isSigner: false },
        { name: "membershipAccount"; isMut: true; isSigner: false },
        { name: "systemProgram"; isMut: false; isSigner: false },
        { name: "rent"; isMut: false; isSigner: false },
        { name: "tokenProgram"; isMut: false; isSigner: false }
      ];
      args: [{ name: "args"; type: { defined: "AddMemberArgs" } }];
    },
    {
      name: "addMemberNft";
      accounts: [
    ...
    },
    {
      ...
      accounts: [
        { name: "authority"; isMut: false; isSigner: true },
        { name: "membershipKey"; isMut: false; isSigner: false },
        { name: "membershipMintTokenAccount"; isMut: false; isSigner: false },
        { name: "fanout"; isMut: true; isSigner: false },
    ...
    },
    {
      ...
      accounts: [
        ...
        { name: "membershipAccount"; isMut: true; isSigner: false },
        { name: "fanout"; isMut: true; isSigner: false },
        { name: "holdingAccount"; isMut: false; isSigner: false },
        { name: "fanoutMint"; isMut: false; isSigner: false },
        { name: "fanoutMintMembership"; isMut: false; isSigner: false },
        { name: "mint"; isMut: false; isSigner: false },
        { name: "systemProgram"; isMut: false; isSigner: false },
        { name: "rent"; isMut: false; isSigner: false },
        { name: "tokenProgram"; isMut: false; isSigner: false }
      ];
      args: [{ name: "args"; type: { defined: "DistributeMemberArgs" } }];
    }
  ];
  accounts: [
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: "totalMembers"; type: "u32" },
          { name: "totalInflow"; type: "u64" },
          { name: "lastSnapshotAmount"; type: "u64" },
          { name: "bumpSeed"; type: "u8" },
          { name: "accountOwnerBumpSeed"; type: "u8" },
          { name: "totalAvailableShares"; type: "u64" },
          { name: "membershipModel"; type: { defined: "MembershipModel" } },
          { name: "membershipMint"; type: { option: "publicKey" } },
          { name: "totalStakedShares"; type: { option: "u64" } }
        ];
      };
    },
    {
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          { name: "totalInflow"; type: "u64" },
          { name: "lastInflow"; type: "u64" },
          { name: "amountAtStake"; type: { option: "u64" } },
          { name: "bumpSeed"; type: "u8" },
          { name: "shares"; type: { option: "u64" } },
          { name: "membershipKey"; type: { option: "publicKey" } }
        ];
      };
    },
    {
      ...
      type: {
        kind: "struct";
        fields: [
          { name: "fanoutMint"; type: "publicKey" },
          { name: "lastInflow"; type: "u64" },
          { name: "amountAtStake"; type: { option: "u64" } },
          { name: "bumpSeed"; type: "u8" }
        ];
  ...
  types: [
    {
      ...
      type: {
        ...
        fields: [
          { name: "bumpSeed"; type: "u8" },
          { name: "nativeAccountBumpSeed"; type: "u8" },
          { name: "name"; type: "string" },
          { name: "totalShares"; type: "u64" },
          { name: "membershipModel"; type: { defined: "MembershipModel" } }
        ];
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          { name: "mintFanoutMembershipBump"; type: "u8" }
        ];
      };
    },
    {
  ...
  errors: [
    ...
    { code: 301; name: "InvalidAuthority"; msg: "Invalid authority" },
    {
      code: 302;
      name: "InsufficientShares";
      msg: "Not Enough Available Shares";
    ...
    { code: 308; name: "MintDoesNotMatch"; msg: "Invalid Mint for the config" },
    {
      code: 309;
      name: "InvalidHoldingAccount";
      msg: "Holding account does not match the config";
    ...
    { code: 311; name: "DerivedKeyInvalid" },
    { code: 312; name: "IncorrectOwner" },
    {
      code: 313;
      name: "WalletDoesNotOwnMembershipToken";
      msg: "Wallet Does not Own Membership Token";
...
export type FanoutMembershipVoucher =
  IdlAccounts<FanoutIDL>["fanoutMembershipVoucher"];

export type FanoutMembershipMintVoucher =
  IdlAccounts<FanoutIDL>["fanoutMembershipMintVoucher"];
